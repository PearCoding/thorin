    ...
    , kernel_config_(kernel_config)
{
    ...
    if (triple.isArch32Bit()) {
        module().setDataLayout("e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-i128:128:128-f32:32:32-f64:64:64-v16:16:16-v32:32:32-v64:64:64-v128:128:128-n16:32:64");
    ...
    llvm::Metadata* annotation_values[] = {
        llvm::ConstantAsMetadata::get(irbuilder.getInt32(2)),
        llvm::ConstantAsMetadata::get(irbuilder.getInt32(0))
    };
    nvvmir_version_md->addOperand(llvm::MDNode::get(context(), annotation_values));
}
